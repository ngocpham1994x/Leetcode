...
public class P00005MostBookedHotelRoom {
    ...
    public static String solution(String[] rooms){
        ...
        ArrayList mostBookedRoomsList = new ArrayList();   //for situation when there are more than 1 room got booked same max times
        ...
        answer = (String) mostBookedRoomsList.get(0);  //because the rooms are sorted, therefore the 0 index is always the smallest
